	...
	<div class="row">
		<div class="col">
			<div class="page-description">
				<h1><?= $titleName; ?> • <span id="text_product_sub_category"></span></h1>
			</div>
		</div>
	</div>
					...
					<form id="form" method="post" class="row g-3">
						<div class="col-md-4">
							<div class="mb-3">
								...
								<input type="hidden" id="product_sub_category_id" name="product_sub_category_id" value="<?= $product_sub_category_id; ?>">
